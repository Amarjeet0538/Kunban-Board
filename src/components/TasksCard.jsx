...
return (
	<>
		<div className="bg-white border border-gray-200 rounded-md p-4 hover:shadow-md hover:border-gray-400 cursor-pointer relative" draggable="true" onMouseEnter={ () => {setIsMouseOver(true)}} onMouseLeave={ () => {setIsMouseOver(false)}}>

			{isMouseOver && <button className="absolute right-1 top-2 hover:bg-red-300 rounded-md cursor-pointer p-1 "><X size={25} onClick={() => {handleDelete(task.id)}}/></button> }
